 ...
 */
    ...
    $page = 'Products';
    $parameter = $data['category_details']['slug'] ?? '';
    $parameter_title = $data['category_details']['title'] ?? '';
...
<main class="container mt-4 main">
    ...
    <!-- START PAGE CONTENT -->
    <form id="main-form" action="products/update" method="post">
        <div class="card mt-4 bg-<?= $dark ? 'dark text-white' : 'light' ?> mb-3">
            <div class="card-header"><?= $page ?></div>
            <div class="card-body">
                <a href="products/product" class="btn btn-success"><i
                        class="fa-solid fa-plus"></i> Add New <?= ucwords(substr($controller, 0, -1)) ?></a>
                <a href="categories/" class="btn btn-primary"><i
                        class="fa-solid fa-layer-group"></i> View Categories</a>
                <div class="btn-group" role="group">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="tools"
                            ...
                            <a class="dropdown-item" href="products/generate_product_slugs">Regenerate Product Slugs</a>
                        </div>
                    </div>
                </div>
            </div>
